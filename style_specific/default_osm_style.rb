...
def get_expected_tag_status
    return [
        ...
        Status.new('area', 'yes', :composite, {'barrier' => 'hedge'}),
        ...
        Status.new('natural', 'bare_rock', :primary),
        ...
        Status.new('natural', 'scree', :primary),
        Status.new('natural', 'saddle', :primary),
        Status.new('natural', 'scrub', :primary),
        Status.new('natural', 'shingle', :primary),
