...
module CartoCSSHelper::StyleDataForDefaultOSM
  def self.get_style_data
    min_z = 4
    max_z = 22
    return StyleSpecificData.new(min_z, max_z, get_expected_tag_status, get_composite_sets)
  end
  ...
  def self.get_expected_tag_status
      return [
          ...
          TagRenderingStatus.new('admin_level', '*', :ignored),
          ...
          TagRenderingStatus.new('aerialway', '*', :ignored),
          ...
          TagRenderingStatus.new('amenity', '*', :ignored),
          ...
          TagRenderingStatus.new('area', '*', :ignored),
          ...
          TagRenderingStatus.new('bicycle', '*', :ignored),
          TagRenderingStatus.new('bicycle', 'designated', :composite, {'highway'=>'path'}),
          TagRenderingStatus.new('boundary', '*', :ignored),
          ...
          TagRenderingStatus.new('brand', '*', :ignored),
          TagRenderingStatus.new('bridge', '*', :ignored),
          ...
          TagRenderingStatus.new('capital', '*', :ignored),
          ...
          TagRenderingStatus.new('covered', '*', :ignored),
          TagRenderingStatus.new('covered', 'yes', :composite, {'highway'=>'service'}),
          TagRenderingStatus.new('culvert', '*', :ignored),
          TagRenderingStatus.new('cutting', '*', :ignored),
          TagRenderingStatus.new('denomination', '*', :ignored),
          TagRenderingStatus.new('denomination', 'jehovahs_witness', :composite, {'amenity'=>'place_of_worship', 'religion'=>'christian'}),
          TagRenderingStatus.new('disused', '*', :ignored),
          TagRenderingStatus.new('ele', '*', :composite, {'natural'=>'peak'}),
          TagRenderingStatus.new('embankment', '*', :ignored),
          TagRenderingStatus.new('foot', '*', :ignored),
          TagRenderingStatus.new('foot', 'designated', :composite, {'highway'=>'path'}),
          TagRenderingStatus.new('generator:source', '*', :ignored),
          TagRenderingStatus.new('generator:source', 'wind', :composite, {'power'=>'generator'}),
          TagRenderingStatus.new('harbour', '*', :ignored),
          TagRenderingStatus.new('highway', '*', :ignored),
          ...
          TagRenderingStatus.new('historic', '*', :ignored),
          ...
          TagRenderingStatus.new('layer', '*', :ignored),
          ...
          TagRenderingStatus.new('layer', '-4', :composite, {'highway' => 'service'}), #modifies ordering
          TagRenderingStatus.new('layer', '-5', :composite, {'highway' => 'service'}), #modifies ordering
          TagRenderingStatus.new('leisure', '*', :ignored),
          ...
          TagRenderingStatus.new('office', '*', :ignored),
          TagRenderingStatus.new('oneway', '*', :ignored),
          TagRenderingStatus.new('oneway', '-1', :composite, {'highway'=>'service'}),
          TagRenderingStatus.new('oneway', 'yes', :composite, {'highway'=>'service'}),
          TagRenderingStatus.new('operator', '*', :ignored),
          TagRenderingStatus.new('place', '*', :ignored),
          ...
          TagRenderingStatus.new('population', '*', :ignored),
          TagRenderingStatus.new('power', '*', :ignored),
          ...
          TagRenderingStatus.new('power_source', '*', :ignored),
          TagRenderingStatus.new('power_source', 'wind', :composite, {'power'=>'generator'}),
          TagRenderingStatus.new('public_transport', '*', :ignored),
          TagRenderingStatus.new('railway', '*', :ignored),
          TagRenderingStatus.new('railway', 'INT-preserved-ssy', :ignored),
          TagRenderingStatus.new('railway', 'INT-spur-siding-yard', :ignored),
          ...
          TagRenderingStatus.new('religion', '*', :ignored),
          ...
          TagRenderingStatus.new('route', '*', :ignored),
          TagRenderingStatus.new('route', 'ferry', :primary),
          TagRenderingStatus.new('service', '*', :ignored),
          ...
          TagRenderingStatus.new('shop', '*', :ignored),
          ...
          TagRenderingStatus.new('shop', 'pets', :primary),
          ...
          TagRenderingStatus.new('sport', '*', :ignored),
          TagRenderingStatus.new('surface', '*', :ignored),
          TagRenderingStatus.new('toll', '*', :ignored),
          TagRenderingStatus.new('tourism', '*', :ignored),
          ...
          TagRenderingStatus.new('tower:type', '*', :ignored),
          TagRenderingStatus.new('tracktype', '*', :ignored),
          ...
          TagRenderingStatus.new('tunnel', '*', :ignored),
          ...
          TagRenderingStatus.new('tunnel', 'no', :ignored),
          TagRenderingStatus.new('tunnel', 'yes', :composite, {'highway'=>'service'}),
          TagRenderingStatus.new('water', '*', :ignored),
          TagRenderingStatus.new('waterway', '*', :ignored),
          ...
          TagRenderingStatus.new('wetland', '*', :ignored),
          TagRenderingStatus.new('width', '*', :ignored),
          TagRenderingStatus.new('wood', '*', :ignored),
      ]
  end
